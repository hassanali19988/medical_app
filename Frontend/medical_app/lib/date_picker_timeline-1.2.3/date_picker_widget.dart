...
//            print("Inside Inactive dates.");
          ...
          return DateWidget(
            ...
            monthTextStyle: isDeactivated
                ...
                : isSelected
                    ? GoogleFonts.vazirmatn(fontSize: 18,color: Colors.white)//selectedMonthStyle
                    : widget.monthTextStyle,
            dateTextStyle: isDeactivated
                ? deactivatedDateStyle
                : isSelected
                    ? GoogleFonts.vazirmatn(fontSize: 18,color: Colors.white)//selectedDateStyle
                    : widget.dateTextStyle,
            dayTextStyle: isDeactivated
                ? deactivatedDayStyle
                : isSelected
                    ? GoogleFonts.vazirmatn(fontSize: 18,color: Colors.white) //selectedDayStyle
                    : widget.dayTextStyle,
            width: widget.width,
